...
- **방금 완료**: Day 5 (관측 + CI — `@sentry/nextjs` instrumentation 3종 + source map, `posthog-js` pageview/identify, GitHub Actions typecheck·lint·build, Vercel prod에서 이벤트 도달 검증)
